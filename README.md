...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/story-text-to-image
```

A live public deployment of this template is available at [https://story-text-to-image.templates.workers.dev](https://story-text-to-image.templates.workers.dev)
